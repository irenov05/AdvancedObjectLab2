/**
 * Holds the Rook's Attributes, constructs, and paramenters.
 * 
 * @author Ismael Renova
 * @version 1.0
 * @since 9/15/26
 * 
 * Change logs: Adding some changes towards verifyTarget method. Leaving public access towards information.
 * 
 */
public class Rook {
    ...
    /**
     * Creates a Rook with its starting information.
     *
     ...
     */
    public Rook(PieceType pieceName, String color, char col, int row) {
    ...
    /**
     * Checks if the Rook can move to the target position.
     *
    ...
    public boolean verifyTarget(char newCol, int newRow) {
        ...
        // Checks if it moves one row forward while column remains unmoved.
        if (col == newCol && row != newRow) {
            return true;
        }
        // Checks if it moves one column forward while row remains unmoved.
